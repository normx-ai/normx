...
export const CONTRATS_PARTICULIERS = [
  'Aucun',
  'Contrat aide',
  "Contrat d'insertion",
];

export const FORMES_AMENAGEMENT_TEMPS = [
...
export const CATEGORIES_SALARIE = [
  { value: '', label: 'Sélectionnez...' },
...
export const HEURES = Array.from({ length: 24 }, (_, i) => ({
...
export const TYPES_SALAIRE = ['Mensuel', 'Horaire', 'Forfait jour', 'Forfait heure'];

export const JOURS_PAIEMENT = ['Dernier jour du mois', '25', '28', '1er du mois suivant'];

export const JOURS_SEMAINE = ['Lundi', 'Mardi', 'Mercredi', 'Jeudi', 'Vendredi', 'Samedi', 'Dimanche'];

export const STATUTS_JOUR = ['Ouvert', 'Fermé', 'Férié'];

// Planning par defaut Congo: 8h/jour, 40h/semaine
export const DEFAULT_PLANNING_SALARIE = JOURS_SEMAINE.map((jour, i) => ({
  jour,
  statut: i < 5 ? 'Ouvert' : i === 5 ? 'Fermé' : 'Férié',
  heures: '8,00',
}));

export const SECTIONS_ADMINISTRATIF = [
...
export const ANCIENNETE_LIGNES = [
...
export const METHODES_CALCUL_MAINTIEN = [
  { value: '', label: 'Sélectionnez...' },
...
export const DEDUCTIONS_FORFAITAIRES = [
  { value: '', label: 'Aucune' },
  { value: '10', label: '10%' },
  { value: '20', label: '20%' },
  { value: '30', label: '30%' },
...
export const FACTEURS_PENIBILITE = [
...
export const APTITUDES = ['Apte', 'Apte avec réserves', 'Inapte temporaire', 'Inapte définitif'];

export const SECTEURS_CONTRAT = ['Privé', 'Public', 'Associatif', 'Particulier employeur'];
...
export const CODES_CLASSIFICATION_QUALIFICATION = [
  'Manoeuvre ordinaire',
...
export const ABSENCES_CONGES_PAYEES = [
  'Congés payés',
  'Congé maladie',
  'Congé maternité',
  'Congé paternité',
...
export function getEmptySalarieForm() {
  return {
    identite: {
