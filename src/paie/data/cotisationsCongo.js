 ...
 */
export function calculerQuotientFamilial(situation, nombreEnfants) {
 ...
 */
export function calculerCNSSSalariale(salaireBrut) {
 ...
 */
export function calculerCNSSPatronale(salaireBrut) {
 ...
 */
export function calculerITS(salaireBrut, cnssSalariale, situation, nombreEnfants, profilResident) {
 ...
 */
export function calculerTUS(salaireBrut, profilResident) {
 ...
 */
export function calculerTOL(zone) {
 ...
 */
export function calculerCAMU(salaireBrut, cnssSalariale) {
 ...
 */
export function calculerTaxeRegionale(moisJanvier) {
 ...
 */
export function calculerAvantagesForfaitaires(salairePresence) {
