...
function PaieDashboard({ etablissements, onAddEtablissement, cabinetId }) {
  const [showWizard, setShowWizard] = useState(false);
  const [searchRS, setSearchRS] = useState('');
  const [searchNUI, setSearchNUI] = useState('');

  const handleSaveEtablissement = (data) => {
            ...
            <tr className="etab-search-row">
              <th>
                <div className="etab-search-cell">
                  <input type="text" value={searchRS} onChange={e => setSearchRS(e.target.value)} placeholder="" />
                </div>
              </th>
              <th>
                <div className="etab-search-cell">
                  <input type="text" value={searchNUI} onChange={e => setSearchNUI(e.target.value)} placeholder="" />
                </div>
              </th>
              <th></th>
            </tr>
