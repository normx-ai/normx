...
const ALL_RUBRIQUES: Rubrique[] = [
  ...
  { label: 'Bâtiments hors immeuble de placement', prefixes: ['231', '232', '233', '2391'] },
  { label: 'Bâtiments - immeuble de placement', prefixes: ['234'] },
  { label: 'Aménagements, agencements et installations', prefixes: ['235', '236', '237', '238', '2392', '2393'] },
