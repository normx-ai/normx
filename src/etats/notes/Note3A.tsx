  ...
  useEffect(() => {
    ...
    fetch('/api/entites/' + entiteId)
      ...
      .then(ent => {
        const data = ent.data || {};
        setParams(data);
        setCommentaire(data['note3a_commentaire'] || DEFAULT_COMMENTAIRE);
        if (data['note3a_adjustments']) {
          try { setAdjustments(JSON.parse(data['note3a_adjustments'])); } catch { /* */ }
        }
      })
      .catch(() => {});
  }, [entiteId]);
    ...
    <div>
      ...
      <div ref={pageRef} style={{
        ...
        <div className="etat-header-officiel">
          ...
          <div className="etat-sub-titre">NOTE 3A : IMMOBILISATION BRUTE</div>
        </div>
