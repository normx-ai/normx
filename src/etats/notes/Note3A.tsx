...
const ALL_RUBRIQUES: Rubrique[] = [
  ...
  { label: 'Terrains', prefixes: ['221', '222', '223', '225', '226', '227', '228', '229'] },
  { label: 'Travaux de mise en valeur des terrains', prefixes: ['224'] },
  { label: 'Bâtiments', prefixes: ['231', '232', '233', '237', '2391'] },
  { label: 'Aménagements, agencements et installations', prefixes: ['234', '235', '238', '2392', '2393'] },
