...
const ALL_RUBRIQUES: Rubrique[] = [
  ...
  // CORPORELLES
  { label: 'Terrains', prefixes: ['2821', '2822', '2823', '2825', '2826', '2827', '2828', '2829'] },
  { label: 'Travaux de mise en valeur des terrains', prefixes: ['2824'] },
  { label: 'Bâtiments', prefixes: ['2831', '2832', '2833', '2837'] },
  { label: 'Aménagements, agencements et installations', prefixes: ['2834', '2835', '2836', '2838'] },
...
function Note3C({ entiteName, entiteNif = '', entiteId, offre, onBack }: Note3CProps): React.JSX.Element {
  ...
  useEffect(() => {
    ...
    setCommentaire(params['note3c_commentaire'] || DEFAULT_COMMENTAIRE);
    if (params['note3c_adjustments']) {
      try { setAdjustments(JSON.parse(params['note3c_adjustments'])); } catch { /* */ }
    }
  }, [params]);
